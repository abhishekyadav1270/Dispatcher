...
class GetPhotoFromWebCam extends React.Component {
  constructor() {
    super();
    this.cameraNumber = 0;
    this.state = {
  ...
  capturePicture = () => {
    ...
    console.log('capture picture', canvas.toDataURL());
    this.props.setImageMessage(canvas.toDataURL())
  ...
  render() {
    ...
    return (
      <div >
        <br />
        <button className='camera-open' onClick={this.initializeMedia}> </button>
        <span >Open WebCam</span>
        <br />
        <br />
        <button className="capture_img" onClick={this.capturePicture}></button>
...
export default GetPhotoFromWebCam;